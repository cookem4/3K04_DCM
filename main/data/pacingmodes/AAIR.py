...
class AAIR(PacingMode):
    ...
    def __init__(self, lower_rate_limit, upper_rate_limit, atrial_amplitude, atrial_pulse_width, arp, sensor_rate, atrial_sensitivity):
        super().__init__(
...
class AAIRBuilder:
    ...
    def from_string(string):
        ...
        return AAIR(aai_dict["lower_rate_limit"], aai_dict["upper_rate_limit"],aai_dict["atrial_amplitude"],
                    aai_dict["atrial_pulse_width"], aai_dict["arp"], aai_dict["sensor_rate"], aai_dict["atrial_sensitivity"])
