...
class VOOR(PacingMode):
    ...
    def __init__(self, lower_rate_limit, upper_rate_limit, ventricular_amplitude, ventricular_pulse_width, activity_threshold, reaction_time, recovery_time):
        super().__init__(
...
class VOORBuilder:
    ...
    def from_string(string):
        ...
        return VOOR(pm_dict["lower_rate_limit"], pm_dict["upper_rate_limit"], pm_dict["ventricular_amplitude"],
                    pm_dict["ventricular_pulse_width"], pm_dict["activity_threshold"], pm_dict["reaction_time"], pm_dict["recovery_time"])

    @staticmethod
    def empty():
        return VOOR(60, 120, 3.5, 1, 3, 30, 5)
