...
class DOOR(PacingMode):
    ...
    def __init__(self, lower_rate_limit, upper_rate_limit, atrial_amplitude, atrial_pulse_width, ventricular_amplitude,
                 ventricular_pulse_width, activity_threshold, reaction_time, recovery_time, av_delay):
        super().__init__(
    ...
    def serialize(self) -> bytearray:
        ...
        serial_bytes = [0 for x in range(11)]
        ...
        serial_bytes[10] = serial_self.av_delay
...
class DOORBuilder:
    ...
    def from_string(string):
        ...
        return DOOR(aai_dict["lower_rate_limit"], aai_dict["upper_rate_limit"], aai_dict["atrial_amplitude"],
                    ...
                    aai_dict["ventricular_pulse_width"], aai_dict["activity_threshold"],aai_dict["reaction_time"], aai_dict["recovery_time"], aai_dict["av_delay"])

    @staticmethod
    def empty():
        return DOOR(60, 120, 3.5, 1, 3.5, 1, 3, 30, 5, 100)
